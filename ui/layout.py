...
from features.add_filter_word import build_add_filter_word_panel  # 导入过滤词管理功能
...
class AppLayout:
    ...
    def _build_ui(self):
        ...
        menu_items = ["文件夹对比", "违规文件清理", "数据库比对","文件名批量修改", "电视剧名称专用", "去片头片尾", "过滤词管理"]
